<template>
  <section>
    ...
    <div v-if="selectedExam" class="mt-8 rounded-2xl border border-slate-200 bg-slate-50 p-5">
      ...
      <p class="mt-5 text-sm text-slate-600">
        Na próxima etapa, esta área carregará as questões da prova e permitirá a submissão das respostas.
      </p>
    </div>
  </section>
</template>
